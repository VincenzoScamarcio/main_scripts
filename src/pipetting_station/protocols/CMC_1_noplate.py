...
def run(protocol: protocol_api.ProtocolContext):
    ...
    reservoir_1 = protocol.load_labware('opentrons_10_tuberack_nest_4x50ml_6x15ml_conical', 1)
    ...
    _pick_up(pip, )
    pipette.transfer(diluent_volume, reservoir_1.well('A1'), plate.well('A1'), new_tip="never")
    pipette.drop_tip()

    _pick_up(pip, )
    pipette.transfer(diluent_volume, reservoir_1.well('A2'), plate.well('A1'), new_tip="never")
    pipette.drop_tip()

    _pick_up(pip, )
    pipette.transfer(diluent_volume, reservoir_1.well('A3'), plate.well('A1'), new_tip="never")
    pipette.drop_tip()

    _pick_up(pip, )
    pipette.transfer(diluent_volume, reservoir_1.well('B1'), plate.well('A1'), new_tip="never")
    pipette.drop_tip()

    _pick_up(pip, )
    pipette.transfer(diluent_volume, reservoir_1.well('B2'), plate.well('A1'), new_tip="never")
    pipette.drop_tip()
